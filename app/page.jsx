  ...
  return (
    <>
      ...
      <div className='relative w-full h-full '>
        <div className="w-full bg-none lg:bg-[url('/images/banner.png')] lg: h-[784px] top-[83px] bg-cover bg-right lg:bg-center bg-no-repeat flex justify-center items-center">
          {/* <Image
          src={banner}
          className='object-cover w-full min-h-screen'
          alt='test'
        /> */}
          <main className='absolute flex flex-col items-start justify-center mx-auto space-y-16 font-san w-[90%]'>
            <div className='flex flex-col items-center space-y-4 text-center md:text-start md:items-start md:w-1/2'>
              ...
              <p className='w-[80%] text-base'>
                ...
                own a Logistics company and want to get a lot more orders a
                better way to manage your Riders, Or a user that wants your
                deliveries to move right now, while offering safety, tracking
                and faster delivery.
              </p>
            </div>
