  ...
  return (
    <>
      <div className='w-full text-white bg-black '>
        <div className='grid items-center min-h-[471px] md:min-h-full bg-black justify-center h-full grid-cols-1 md:py-10 px-2 xl:px-0 py-5 mx-auto md:grid-cols-3 md:w-[90%] w-full'>
